...
const PATH : &'static str = "src/adder_v2/project/a07_dual_out_toggle/excel/uf31_v01_c02.txt";
...
fn replaced() -> Vec<(String, String)> {
    let replaced = vec![
        ("XOR2D1BM156H3P48CPDELVT_EXCELSPECIAL_2".to_string(), "XOR2D1BM156H3P48CPDULVT_ELVT_GDI".to_string()),
        ("XNR2D1BM156H3P48CPDELVT_EXCELSPECIAL_2".to_string(), "XNR2D1BM156H3P48CPDULVT_ELVT_GDI".to_string()),
    ];
    replaced
}
...
fn test_cdl() {
    let adder = adder();
    let mut txt = adder.to_cdl("ADDER_UF31_PN_V01_C02", Process::N3E);
...
fn test_netlist() {
    ...
    let mut txt = adder.to_netlist("adder_uf31_np_v01_c02", Process::N3E, decr_info);
