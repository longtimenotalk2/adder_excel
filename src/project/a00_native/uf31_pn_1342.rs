...
const PATH : &'static str = "src/project/a00_native/excel_data/uf31_pn_1342.txt";
const INPUT_IS_NEG : bool = false;
const OUTPUT_IS_NEG : bool = true;
...
fn test_cdl() {
    ...
    let content = adder.to_cdl_std(ProcessAndProject::N4C1340, "UFADDER_PP_31_BASE_10");
