...
const PATH : &'static str = "src/project/a03_domino_e07/excel_data/base00.txt";
// 修前序
...
fn adder_create() -> Adder {
    ...
    excel_data.create_with_end_xnr_not_new(31, INPUT_IS_NEG, OUTPUT_IS_NEG, vec![22], vec![25])
}
...
fn test_cdl() {
    let adder = adder_create();
    let content = adder.to_cdl_std(ProcessAndProject::N4C1340, "UFADDER_PP_31_BASE00");
