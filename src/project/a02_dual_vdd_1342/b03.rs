...
const PATH : &'static str = "src/project/a02_dual_vdd_1342/excel_data/b03.txt";
...
fn test_cdl() {
    let excel_data = ExcelData::load(PATH);
    let adder = excel_data.create(31, false, true);
    let content = adder.to_cdl_std(ProcessAndProject::N4C1342H200, "UFADDER_PN_1342_H200_B03");
